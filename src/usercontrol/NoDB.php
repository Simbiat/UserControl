...
{    
    ...
    public function argonCalc(float $targettime = 1.0): array
    {
        ...
        #Write config file
        file_put_contents(__DIR__.'/json/argon.json', json_encode($argonSettings, JSON_PRETTY_PRINT));
        return $argonSettings;
    }
    
    #Helper function to get count of available cores
    public function countCoures(): int
    {
    ...
    public function genCrypto(): array
    {
        ...
        #Write config file
        file_put_contents(__DIR__.'/json/aes.json', json_encode($cryptoSettings, JSON_PRETTY_PRINT));
